...
const PASSWORD = process.env.NEXT_PUBLIC_ADMIN_PASSWORD || 'littlesound2026';
      ...
      <div className="min-h-screen bg-[#F5EFE0] flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl shadow-sm border border-[#E8DFC8] p-8 w-full max-w-sm">
          ...
          <input
            ...
            className="w-full border border-[#C5D8E8] rounded-xl px-4 py-3 text-sm font-['DM_Sans'] outline-none focus:border-[#0D5C6E] mb-3"
          />
          {pwError && (
            <p className="text-red-500 text-xs font-['DM_Sans'] mb-3">Incorrect password</p>
          )}
          <button
            onClick={() => {
              if (pwInput === PASSWORD) setAuthed(true);
            ...
            className="w-full bg-[#0D5C6E] text-white rounded-full py-3 text-sm font-['DM_Sans'] font-semibold hover:bg-[#1A7A8A] transition-colors"
          >
            Sign in
          </button>
        </div>
    ...
    <div className="min-h-screen bg-[#F5EFE0] font-['DM_Sans']">
      ...
      <header className="bg-white border-b border-[#E8DFC8] px-6 py-4 flex items-center justify-between">
        <div>
          ...
          <p className="text-[#7A9AAA] text-xs mt-0.5">Provider listing submissions</p>
        </div>
        <button

...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    ...
    // Supabase fires PASSWORD_RECOVERY once it detects the recovery tokens
    // from the reset-link URL and establishes a temporary session that's
    // only good for calling updateUser({ password }).
    ...
    // If a session already exists by the time this mounts (tokens can be
    // processed before the listener attaches), treat that as valid too.
